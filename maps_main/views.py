...
def maps_main_home(request):
    ...
    if request.method == "GET":
        address_object = Address.objects.filter(fusion_table__google_id=request.session.get("fusion_table_id")).all()
    ...
    address_object = Address.objects.filter(full_address=formatted_address).first()
