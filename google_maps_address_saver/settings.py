"""
Django settings for google_maps_address_saver project.
...
SECRET_KEY = '=)hysahwl=+#vgt4zkdlvezsl=!1ms%28^@h8x71nzgg4l$x^6'
...
ROOT_URLCONF = 'google_maps_address_saver.urls'
...
WSGI_APPLICATION = 'google_maps_address_saver.wsgi.application'
